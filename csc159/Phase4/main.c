...
int main(void) {  // OS bootstraps
	...
	fill_gate(&IDT_p[TIMER_EVENT], (int)TimerEvent, get_cs(), ACC_INTR_GATE, 0); //fill out IDT entry #32 like in the timer lab exercise
	...
	outportb(0x21, ~0x1); //set the PIC mask to open up for timer event signal (IRQ0)
